...
# -------------------------
st.set_page_config(page_title="PDF & Webpage RAG App", layout="centered")
st.title("RAG Application")

# -------------------------
# Step 1: Upload PDFs + URLs
# -------------------------
...
Your task is to rewrite the user's question into a clear, standalone query for document retrieval.
Use the chat history for context. Do NOT answer the question."""),
...
def agent_node(state: MessagesState):
    ...
    # Inject chat history into tool calls
...
if user_input:
    ...
    serialized_history = serialize_messages(st.session_state["messages"])
